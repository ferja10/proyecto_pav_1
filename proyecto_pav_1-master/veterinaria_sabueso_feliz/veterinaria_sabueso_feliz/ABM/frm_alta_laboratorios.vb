Public Class frm_alta_labortorios
    ...
    Private Sub Alta_Laboratorios_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        CambioGrilla()
        Limpiar()
        tablaLab = modulo._leo_tabla("id_laboratorio,razon_social AS 'Razon Social',direccion AS Direccion,estado", "LABORATORIOS", "estado = 1")
    ...
    Private Sub btn_nuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_nuevo.Click
        ...
        txt_Id.Text = modulo.valorId("LABORATORIOS", "id_laboratorio")
    End Sub
    ...
    Function Validar() As Boolean
        ...
        If Existe("LABORATORIOS", "razon_social = '" & txt_RazonSocialNew.Text & "'") Then
            If MsgBox("Ya existe un Laboratorio con esta Razon Social, ¿Desea Restaurar los datos?", MsgBoxStyle.OkCancel, "¡Atención!") = MsgBoxResult.Ok Then
                ...
                Limpiar()
                CambioGrilla()
                cargar_grilla(modulo._leo_tabla("id_laboratorio,razon_social AS 'Razon Social',direccion AS Direccion,estado", "LABORATORIOS", "estado = 1"))
            End If
            Return False
        End If
    ...
    Private Sub txt_Razon_Social_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Razon_Social.KeyUp
        cargar_grilla(_leo_tabla("id_laboratorio,razon_social AS 'Razon Social',direccion AS Direccion,estado", "LABORATORIOS", "razon_social LIKE '%" & txt_Razon_Social.Text & "%' and estado = 1 "))
    End Sub
End Class