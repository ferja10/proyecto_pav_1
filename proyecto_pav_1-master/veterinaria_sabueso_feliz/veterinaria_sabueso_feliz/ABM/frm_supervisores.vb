Public Class frm_supervisores
    ...
    Private Sub frm_supervisores_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        _cargar_combo(cmb_tipo_doc_sup, _leo_tabla("TIPO_DOCUMENTO"), "id_tipo_doc", "descripcion")
        _cargar_combo(cmb_tipo_doc_sup_supl, _leo_tabla("TIPO_DOCUMENTO"), "id_tipo_doc", "descripcion")
        ...
        cargar_grilla(_leo_tabla("E.tipo_doc as 'TIPO DOCUMENTO',E.apellido as APELLIDO, E.nombre as NOMBRE, E.nro_doc as DOCUMENTO,E.matricula as MATRICULA", _
                                "EMPLEADOS E join SUCURSALES S on E.sucursal = S.id_sucursal", "E.estado = 1 and E.sucursal = " & sucursal))
    ...
    Private Sub txt_apellido_TextChanged(sender As System.Object, e As System.EventArgs) Handles txt_apellido.TextChanged
        ...
        cargar_grilla(_leo_tabla("E.tipo_doc as 'TIPO DOCUMENTO',E.apellido as APELLIDO, E.nombre as NOMBRE, E.nro_doc as DOCUMENTO,E.matricula as MATRICULA", _
                                "EMPLEADOS E join SUCURSALES S on E.sucursal = S.id_sucursal", "E.apellido like '%" & txt_apellido.Text & "%' and E.estado = 1 and E.sucursal = " & sucursal))
    ...
    Private Sub msk_nro_doc_TextChanged(sender As System.Object, e As System.EventArgs) Handles msk_nro_doc.TextChanged
        ...
        cargar_grilla(_leo_tabla("E.tipo_doc as 'TIPO DOCUMENTO',E.apellido as APELLIDO, E.nombre as NOMBRE, E.nro_doc as DOCUMENTO,E.matricula as MATRICULA", _
                                "EMPLEADOS E join SUCURSALES S on E.sucursal = S.id_sucursal", "E.nro_doc like '%" & msk_nro_doc.Text & "%' and E.estado = 1 and E.sucursal = " & sucursal))
    ...
    Private Sub btn_guardar_Click(sender As System.Object, e As System.EventArgs) Handles btn_guardar.Click
        ...
        If rdo_titular.Checked Then
            ...
            If validar_supervisor(False) Then

                guardar_supervisor(dgv_empleados.CurrentRow)

            Else

                MessageBox.Show("El empleado esta cargado como suplente", "Importante")

            End If

        ElseIf rdo_suplente.Checked Then

            If validar_supervisor(True) Then

                guardar_supervisor_suplente(dgv_empleados.CurrentRow)

            Else

                MessageBox.Show("El empleado esta cargado como Titular", "Importante")
    ...
    Private Function validar_supervisor(ByVal titular As Boolean) As Boolean

        If titular Then
            If _leo_tabla("SUCURSALES", "tipo_doc_superv = " & dgv_empleados.CurrentRow.Cells(0).Value & " and nro_doc_superv = " & dgv_empleados.CurrentRow.Cells(3).Value).Rows.Count > 0 Then
                Return False
            Else
                Return True
            End If
        Else
            If _leo_tabla("SUCURSALES", "tipo_doc_super_supl = " & dgv_empleados.CurrentRow.Cells(0).Value & " and nro_doc_super_supl = " & dgv_empleados.CurrentRow.Cells(3).Value).Rows.Count > 0 Then
                Return False
            Else
                Return True
            End If
