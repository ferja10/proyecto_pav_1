Public Class frm_alta_Sucursal
    ...
    Private Sub btn_nuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_nuevo.Click
        ...
        Limpiar()
        modificar = False
        txt_Codigo.Text = modulo.valorId("SUCURSALES", "id_sucursal")
    End Sub
    ...
    Private Sub btn_guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        ...
        Else
            Exit Sub
        End If
        cargarGrilla(modulo._leo_tabla("id_sucursal, nombre AS Nombre, clave, estado", "SUCURSALES", "estado = 1"))
        CambioGrilla()
        Limpiar()
    End Sub
    ...
    Private Sub txt_Buscar_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Buscar.KeyUp
        modulo._cargar_grilla(GrillaSucursales, _leo_tabla("id_sucursal, nombre AS Nombre, clave, estado", "SUCURSALES", "nombre LIKE '%" & txt_Buscar.Text & "%' and estado = 1 "))
    End Sub
End Class